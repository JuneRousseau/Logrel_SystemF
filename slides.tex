...
\begin{frame}
  ...
  \begin{block}{Excerpt semantics with named binders}
      $x,y \in \mathrm{string}$
  ...
  \begin{block}{Substitution}
    \begin{itemize}
      % the subtleties are somehow hidden in the substitution
  ...
  \begin{center}
    Good for presentation, bad for implementation
  \end{center}
